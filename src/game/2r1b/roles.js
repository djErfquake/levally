module.exports = [
    ...
    },
    {
        name: 'Amnesiac',
        team: ['purple'],
        power: 'At the end of the last round, before all players reveal their roles, you must declare which team you are on by saying, "I remember which team I am on. I am on the _________ team." You must choose the red team, blue team, or neither team. To win you need to guess the team allegiance of the [buried] card. If you choose the correct team but your team loses, you lose too.',
        buried: true
    },
    {
        name: 'Born Leader',
